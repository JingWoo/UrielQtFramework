/********************************************************************************
** Form generated from reading UI file 'PatentInfo.ui'
**
...
#ifndef UI_PATENTINFO_H
#define UI_PATENTINFO_H
...
public:
    ...
    QLabel *label_19;
    QDateEdit *AuthorizationTime;
    QSpacerItem *horizontalSpacer_19;
    QHBoxLayout *horizontalLayout_12;
    QLabel *label_16;
    QVBoxLayout *verticalLayout_10;
    QLineEdit *CopyRightUnit;
    QFrame *line_8;
    ...
    void setupUi(QDialog *PatentInfo)
    {
        if (PatentInfo->objectName().isEmpty())
            PatentInfo->setObjectName(QStringLiteral("PatentInfo"));
        PatentInfo->resize(1023, 613);
        QPalette palette;
        ...
        PatentInfo->setPalette(palette);
        horizontalLayout = new QHBoxLayout(PatentInfo);
        ...
        scrollArea = new QScrollArea(PatentInfo);
        ...
        ApplyTime = new QDateEdit(scrollAreaWidgetContents);
        ApplyTime->setObjectName(QStringLiteral("ApplyTime"));
        ApplyTime->setFont(font);
        ApplyTime->setCalendarPopup(true);

        horizontalLayout_10->addWidget(ApplyTime);
        ...
        ReleaseTime->setFont(font);
        ReleaseTime->setCalendarPopup(true);

        horizontalLayout_10->addWidget(ReleaseTime);
        ...
        AuthorizationTime = new QDateEdit(scrollAreaWidgetContents);
        AuthorizationTime->setObjectName(QStringLiteral("AuthorizationTime"));
        AuthorizationTime->setFont(font);
        AuthorizationTime->setCalendarPopup(true);

        horizontalLayout_10->addWidget(AuthorizationTime);
        ...
        CopyRightUnit = new QLineEdit(scrollAreaWidgetContents);
        CopyRightUnit->setObjectName(QStringLiteral("CopyRightUnit"));
        CopyRightUnit->setFont(font);
        CopyRightUnit->setFrame(false);

        verticalLayout_10->addWidget(CopyRightUnit);
        ...
        retranslateUi(PatentInfo);

        QMetaObject::connectSlotsByName(PatentInfo);
    } // setupUi

    void retranslateUi(QDialog *PatentInfo)
    {
        PatentInfo->setWindowTitle(QApplication::translate("PatentInfo", "PatentInfo", Q_NULLPTR));
        label_7->setText(QApplication::translate("PatentInfo", "\344\270\223\345\210\251\347\261\273\345\236\213\357\274\232", Q_NULLPTR));
        label_18->setText(QApplication::translate("PatentInfo", "\344\270\223\345\210\251\345\217\267\357\274\232", Q_NULLPTR));
        Number->setPlaceholderText(QApplication::translate("PatentInfo", "\345\241\253\345\206\231\344\270\223\345\210\251\345\217\267", Q_NULLPTR));
        label_3->setText(QApplication::translate("PatentInfo", "\344\270\223\345\210\251\345\220\215\347\247\260\357\274\232", Q_NULLPTR));
        Name->setPlaceholderText(QApplication::translate("PatentInfo", "\345\241\253\345\206\231\344\270\223\345\210\251\345\220\215\347\247\260", Q_NULLPTR));
        label_8->setText(QApplication::translate("PatentInfo", "\347\224\263\350\257\267\346\227\266\351\227\264\357\274\232", Q_NULLPTR));
        label_9->setText(QApplication::translate("PatentInfo", "\345\205\254\345\270\203\346\227\266\351\227\264\357\274\232", Q_NULLPTR));
        label_19->setText(QApplication::translate("PatentInfo", "\346\216\210\346\235\203\346\227\266\351\227\264\357\274\232", Q_NULLPTR));
        label_16->setText(QApplication::translate("PatentInfo", "\344\270\223\345\210\251\346\211\200\346\234\211\345\215\225\344\275\215:", Q_NULLPTR));
        CopyRightUnit->setPlaceholderText(QApplication::translate("PatentInfo", "\345\241\253\345\206\231\344\270\223\345\210\251\346\211\200\346\234\211\345\215\225\344\275\215", Q_NULLPTR));
        label_15->setText(QApplication::translate("PatentInfo", "\344\275\234\350\200\205\344\277\241\346\201\257\357\274\232", Q_NULLPTR));
        Author->setPlaceholderText(QApplication::translate("PatentInfo", "\345\244\232\344\270\252\344\275\234\350\200\205\344\273\245;\345\210\206\345\274\200", Q_NULLPTR));
        label_17->setText(QApplication::translate("PatentInfo", "\346\224\266\345\275\225\345\234\260\345\235\200\357\274\232", Q_NULLPTR));
        IndexedAddress->setPlaceholderText(QApplication::translate("PatentInfo", "\345\241\253\345\206\231\347\275\221\347\273\234\346\224\266\345\275\225\345\234\260\345\235\200", Q_NULLPTR));
        label_5->setText(QApplication::translate("PatentInfo", "\344\270\212\344\274\240\345\216\237\346\226\207\357\274\232", Q_NULLPTR));
        ServerFileAddress->setText(QApplication::translate("PatentInfo", "\346\227\240", Q_NULLPTR));
        FileBrower->setText(QApplication::translate("PatentInfo", "...", Q_NULLPTR));
        label_4->setText(QApplication::translate("PatentInfo", "\344\270\223\345\210\251\346\221\230\350\246\201\357\274\232", Q_NULLPTR));
        Abstract->setPlaceholderText(QApplication::translate("PatentInfo", "\345\241\253\345\206\231\344\270\223\345\210\251\346\221\230\350\246\201", Q_NULLPTR));
        ConfirmBtn->setText(QApplication::translate("PatentInfo", "\347\241\256\345\256\232\346\267\273\345\212\240", Q_NULLPTR));
        AppClose->setText(QApplication::translate("PatentInfo", "...", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class PatentInfo: public Ui_PatentInfo {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PATENTINFO_H
