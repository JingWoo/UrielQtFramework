...
QT_MOC_LITERAL(1, 12, 13), // "contentSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7) // "content"

    },
    "InputDialog\0contentSignal\0\0content"
};
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InputDialog::contentSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::contentSignal(const QString & _t1)
{
