...
#include "../../ThirdPartyLibraries/QSimpleUpdater/src/Updater.h"
...
QT_MOC_LITERAL(27, 341, 7), // "onReply"
QT_MOC_LITERAL(28, 349, 14), // "QNetworkReply*"
QT_MOC_LITERAL(29, 364, 5), // "reply"
QT_MOC_LITERAL(30, 370, 18), // "setUpdateAvailable"
QT_MOC_LITERAL(31, 389, 9) // "available"
...
void Updater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->onReply((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 15: _t->setUpdateAvailable((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Updater::checkingFinished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Updater::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Updater::downloadFinished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Updater::*_t)(const QString & , const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Updater::appcastDownloaded)) {
                *result = 2;
                return;
            }
        }
