#include "InstrumentBRHistoryTableModel.h"

UrielInstrumentBorrowReturnHistoryTableModel::UrielInstrumentBorrowReturnHistoryTableModel(QString strQuery, QStringList hlist, QSqlDatabase&db, QObject *parent)
...
UrielInstrumentBorrowReturnHistoryTableModel::~UrielInstrumentBorrowReturnHistoryTableModel()
{
}

QVariant UrielInstrumentBorrowReturnHistoryTableModel::data(const QModelIndex &index, int role) const
{
	//if (index.column() == 1)
	//{
	//	switch (role)
