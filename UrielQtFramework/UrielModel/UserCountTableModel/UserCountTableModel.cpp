#include "UserCountTableModel.h"

UrielUserCountTableModel::UrielUserCountTableModel(QString strQuery, QStringList hlist, QSqlDatabase&db, QObject *parent)
...
UrielUserCountTableModel::~UrielUserCountTableModel()
{
}

QVariant UrielUserCountTableModel::data(const QModelIndex &index, int role) const
{
	//if (index.column() == 1)
	//{
	//	switch (role)
