...
#include <QPixmap>
#include <QDateTime>
UrielNoticesMenuTableModel::UrielNoticesMenuTableModel(QString strQuery, QStringList hlist, QSqlDatabase&db, QObject *parent )
...
UrielNoticesMenuTableModel::~UrielNoticesMenuTableModel()
{
}

QVariant UrielNoticesMenuTableModel::data(const QModelIndex &index, int role) const
{
	if (index.column() == 1)
	{
		switch (role)
