...
UrielLoginTableModel::UrielLoginTableModel(QString strQuery, QStringList hlist, QSqlDatabase&db, QObject *parent)
...
UrielLoginTableModel::~UrielLoginTableModel()
{
}

QVariant UrielLoginTableModel::data(const QModelIndex &index, int role) const
{
	//if (index.column() == 1)
	//{
	//	switch (role)
